    ...
    menus: [
        ...
        { key: '/app/operate', title: '数据总揽',icon: 'area-chart',
          subs: [
            ...
            { key: '/app/operate/overview', title: '实时数据', component: 'OverView' },
            ...
            { key: '/app/operate/flowanalysis', title: '报警值设置', component: 'FlowAnalysis' },
            { key: '/app/operate/flowanalysis', title: '报警记录', component: 'FlowAnalysis' },
            ...
            { key: '/app/waterData/realLine', title: '实时曲线', component: 'realLine' },
